...
class NextPage:
    ...
    def get_class_first_name(self):
        return self.driver.find_element(*self.class_first_name).get_attribute("class")

    def get_class_last_name(self):
        return self.driver.find_element(*self.class_last_name).get_attribute("class")
    ...
    def get_class_company(self):
        return self.driver.find_element(*self.class_company).get_attribute("class")
